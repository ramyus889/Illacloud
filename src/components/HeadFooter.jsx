const HeadFooter = () => {
  return (
    <div className="text-center  font-bold text-white mt-[324px]  max-[2000px]:ms-[280px] max-[1900px]:ms-[460px]  max-[1500px]:ms-[320px]">
      ...
      <div className="flex justify-center pt-[24px] gap-10">
